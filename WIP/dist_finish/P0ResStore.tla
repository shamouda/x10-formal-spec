...
RecvLive(here) ==
   ...
   /\ LET  msg == FindIncomingMSG(here, "live")
           ...
           submit == IF isDead[here][src] \/ isDead[here][target]
                     ...
                     ELSE TRUE
      IN  /\ msg # NotMessage
          /\ p0fstates[fid].id # NotID  \* must have been initialized
          /\ IF submit 
...
ReleaseAll(here) ==
    /\ p0state = "release"
    /\ p0fstates' = [r \in IDRange |-> IF  p0fstates[r].numActive = 0 
                                           /\ p0fstates[r].isReleased = FALSE 
                                           /\ p0fstates[r].adopterId = NotID
...
\* Last modified Thu Nov 09 16:59:51 AEDT 2017 by u5482878
